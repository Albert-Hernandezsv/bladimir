      ...
      <div class="box-body">
       ...
       <!--=====================================
            ...
            <div class="modal-body">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tipoDte" id="tipoDte" value="04" hidden>
                    ...
                    <div class="producto-template" style="display:none;">
                        ...
                        <div class="producto-item">
                            <div class="row">
                                            ...
                                            <select name="nuevoIdProductoFactura[]" class="form-control select2 seleccionarProductoFactura">
                                                ...
                                                <?php
                                                    ...
                                                    foreach ($productos as $key => $value){
                                                        if($value["stock"] > 0){
                                                            echo '<option data-peso="'.$value["peso"].'" data-exento="'.$value["exento_iva"].'" data-value="'.$value["id"].'" data-precio="'.$value["precio_venta"].'" data-codigo="'.$value["codigo"].'">'.$value["nombre"].' '.$value["codigo"].'</option>';
                                                        }
                                                    }
                                                ?>
                                            </select>
                                ...
                                <div class="col-xl-2 col-xs-12">
                                    Peso (esto sustituirá el peso del producto en la base de datos):
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
        ...
        <?php
          ...
          $crearFactura -> ctrNotaRemisionManual();
