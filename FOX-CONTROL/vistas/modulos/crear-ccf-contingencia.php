            ...
            <div class="modal-body">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tipoDte" id="tipoDte" value="03" hidden>
                    ...
                    <?php
                        ...
                        if($cliente["tipo_cliente"] == "01"){ // Contribuyente
                            echo '<div class="row">
                        ...
                        if($cliente["tipo_cliente"] == "02" || $cliente["tipo_cliente"] == "03"){ // Beneficios y Diplomáticos
                            echo '<div class="row">
